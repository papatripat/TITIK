// Centralized SVG Icon Library — replaces all emoji with professional SVG icons
// Uses Heroicons-style paths (MIT License) and custom environment-themed icons
...
export function IconLocationPin({ className = '', size = 20 }: IconProps) {
  return (
...
export function IconHourglass({ className = '', size = 20 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
      <path d="M6 2h12M6 22h12M7 2v4a7 7 0 005 6.71M17 2v4a7 7 0 01-5 6.71M7 22v-4a7 7 0 015-6.71M17 22v-4a7 7 0 00-5-6.71" />
    </svg>
  );
}
...
// ─── Waste/Environment Theme Icons ──────────────────────────────────────────

export function IconRobot({ className = '', size = 20 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
...
export function IconRecycle({ className = '', size = 20 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
...
export function IconTrashBin({ className = '', size = 20 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
